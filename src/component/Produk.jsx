...
function Produk() {
    return (
        <>
            <H />
            <div className=" bg-gradient-to-b from-[#4AA1B4] to-[#57C1A0] grid justify-start">
                <div className="grid grid-cols-2">
                    <div class="relative flex flex-col md:flex-row w-auto h-auto mt-6 ml-10 mr-10 bg-white shadow-sm border border-slate-200 bg-opacity-50 rounded-[40px] ">
                        <div class="relative ml-6 mt-6 md:w-2/5 shrink-0 overflow-hidden">
                            <img
                                src={gmbrSP}
                                alt="card-image"
                        ...
                        <div class="p-6">
                            ...
                            <p class="mb-5 text-slate-600 leading-normal font-light text-justify">
                ...
                <div class="relative flex flex-col md:flex-row w-auto h-auto mt-6 mb-6 ml-10 mr-10 bg-white shadow-sm border border-slate-200 bg-opacity-50 rounded-[40px] ">
                    <div class="relative ml-6 mt-6 shrink-0 overflow-hidden">
                        <img
                            src={gmbrSSP}
                            alt="card-image"
                            class=" w-auto rounded-md md:rounded-lg object-cover"
                        />
                    </div>
                    <div class="mt-6 ml-10 mr-6">
                        <div class="mb-2 rounded-full bg-teal-600 py-0.5 px-2.5 border border-transparent text-xs text-white transition-all shadow-sm w-20 text-center">On-Going</div>
                        <h4 class="mb-2 text-slate-800 text-2xl font-semibold">
                            Simpan dan Pinjam
                        </h4>
